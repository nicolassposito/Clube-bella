      ...
      <div className="flex">
        ...
        <div className="w-full h-screen overflow-scroll relative">
          ...
          {pedidos.length > 0 ? (
                ...
                <div key={index} className="pedido p-3 border rounded-xl">
                  <div className="text-center">
                    <p className="flex items-center gap-1 text-base">
                      <TruckIcon size={30} className="text-rose-400 p-1"/>Seu pedido foi postado!
                    </p>
              ...
              <h1 className="border p-3 rounded flex items-center gap-2 justify-center"><Truck size={30} className="text-rose-400"/>Nenhum pedido foi enviado.</h1>
            )}
          </div>
        </div>
      </div>
